...
<p>You can download Lazarus { $dl_latest_version_lazarus } which is accompanied by FPC { $dl_latest_version_fpc } from this page.</p>
...
<h3>DEB Releases</h3>
<ul>
<li><a href="{ $dl_deb32_url }">Lazarus Linux i386 DEB (32 Bits)</a></li>
<li><a href="{ $dl_deb64_url }">Lazarus Linux amd64 DEB (64 Bits)</a></li>
</ul>
<h3>RPM Releases</h3>
<ul>
<li><a href="{ $dl_rpm32_url }">Lazarus Linux i386 RPM (32 Bits)</a></li>
<li><a href="{ $dl_rpm64_url }">Lazarus Linux x86_64 RPM (64 Bits)</a></li>
</ul>

<h2>Mac OS X</h2>
<ul>
<li><a href="{ $dl_mac32_url }">Lazarus Mac OS X i386 (32 Bits)</a></li>
<li><a href="{ $dl_macppc_url }">Lazarus Mac OS X powerpc</a></li>
</ul>

<h2>Sources</h2>
<h3><a href="http://sourceforge.net/projects/lazarus/files/Lazarus%20Zip%20_%20GZip/">Lazarus Zip - GZip</a></h3>

<h2>Other Downloads</h2>
<p>For other downloads, check: <a href="http://sourceforge.net/projects/lazarus/">The SourceForge Project page</a></p>
...
<hr />
<h2>Mirrors</h2>
<p>It is recommended to use <a href="http://sourceforge.net/projects/lazarus/">Sourceforge.net</a> for all the downloads.</p>
